...
public class Operator {
    ...
    public Operator createNewOperatorInstance() {
        // This method is simplified. The MainMenu/GUI controller will handle adding to list and saving.
        // The 'duplicated' flag logic needs to be handled by the controller before calling this.
        // For example, the controller checks if an operator with this name already exists.
        if (!duplicated) { // This 'duplicated' field seems to be instance-specific, which is odd for this context.
                         // It should likely be checked against the global list of operators by the caller.
            this.duplicated = true; // Mark this instance, but the check should be external.
            return this; // Return the newly configured operator instance.
        } else {
            return null; // Indicates duplication based on this instance's flag, but logic is flawed.
        }
    }
